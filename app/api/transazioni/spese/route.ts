...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await prisma.$queryRaw<
      SpesaQueryResult[]
    >(Prisma.sql`select extract(year from data)::integer AS anno, SUM(prezzo) AS totale, spesa.nome as categoria FROM "transazioni" LEFT JOIN categorie_spesa spesa
