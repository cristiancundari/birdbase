...
export const CustomSearchBar = (props: SearchBarProps) => {
  const {
    activateSearch,
    AppMenu,
    ClearInputIcon = IconX,
    exitSearch,
  ...
  const { navOpen = false, closeMobileNav } =
    useChatContext<DefaultStreamChatGenerics>("ChannelList");
